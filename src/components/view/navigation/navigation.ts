...
export default class Navigation {
  ...
  constructor(private readonly controller: Controller, private readonly view: View) {
    ...
    <div class="footer__rsschool">
      <a class="footer__rsschool-link" href="https://rs.school/js/" target="_blank">
        ${rssIcon}
      </a>
    </div>

    <div class="footer__github-links">
      <a class="footer__github-link" href="https://github.com/Aliseiko" target="_blank">Ivan Aliseiko</a>
      <a class="footer__github-link" href="https://github.com/AlexiyKami" target="_blank">Alexey Matsyl</a>
      <a class="footer__github-link" href="https://github.com/Anton-Shcherba" target="_blank">Anton Shcherba</a>
    </div>
